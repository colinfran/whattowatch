...
const DATA = [ShowInfo, ShowTrailer];
...
export default class ShowModal extends React.Component {
  ...
  componentDidMount() {
    return fetch("https://api.themoviedb.org/3/tv/" + this.state.id + "?api_key=dbcdb9d96b827ad1d9d7f6c5d9e2d636&language=en-US")
  ...
  renderScene = ({ route }) => {
    switch (route.key) {
      ...
      case 'second':
        return <ShowTrailer title={this.state.title} videoLoading={this.state.videoLoading}  />;
      default:
        return null;
    }
  }
