...
export default class ShowsTopRated extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: true,
  ...
  // API Call to get TV top rated data
  getTopRated(){
    return fetch("https://api.themoviedb.org/3/tv/top_rated?api_key=dbcdb9d96b827ad1d9d7f6c5d9e2d636&language=en-US&page=1")
