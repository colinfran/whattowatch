...
import { StyleSheet, Text, View, FlatList, ActivityIndicator, Picker } from 'react-native';
      ...
      return (
        <View style={{backgroundColor:"white", flex: 1, flexDirection:'column'}}>
            ...
            <FlatList
             ...
             renderItem={({item}) => <Movie updateModalData={this.updateDataForModal} data={item}></Movie>}
           />
           <Modal
             ...
             >
             <MovieInfo data={this.state.modalData}></MovieInfo>
           </Modal>
